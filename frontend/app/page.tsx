  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden">
        <div className="absolute inset-0 bg-blue-950/30 border-b border-blue-900/20" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-blue-400 text-glow-blue">
            Nexa
          </h1>
      ...
      {/* Features Section */}
      <section id="features" className="py-20 bg-gray-900/30 border-y border-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-center mb-12">Powered by Gemini AI</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-gray-900/50 p-6 rounded-xl border-2 border-gray-800 hover:border-blue-500 transition-all hover:-translate-y-1 shadow-lg hover:shadow-glow-blue">
            ...
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <div className="text-center">
                  <div className="w-12 h-12 bg-blue-600 border-2 border-blue-500 rounded-full flex items-center justify-center mx-auto mb-4 text-xl font-bold shadow-glow-blue">
                    {index + 1}
                  </div>
                ...
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-6 left-full w-8 h-0.5 bg-blue-500 -translate-x-4 shadow-glow-blue" />
                )}
              </div>
            ))}
          </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-blue-950/20 border-t border-blue-900/30">
